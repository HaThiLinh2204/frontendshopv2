      ...
      <div className="footer-navbar">
        <div className="footer-detail">
          <div className="footer-navbar-item">
            <div className="navbar-item-title">FURLAR - THỜI TRANG CAO CẤP</div>
            <div className="item-detail">
              ...
              <div className="detail-email">Email: furlarshop@gmail.com.vn</div>
              <div>Mua hàng gọi: 1100 2468</div>
            </div>
          </div>
          <div className="footer-navbar-item">
            <div className="navbar-item-title">VỀ CHÚNG TÔI</div>
            <div className="item-detail">
          ...
          <div className="footer-navbar-item">
            <div className="navbar-item-title">FANPAGE CHÚNG TÔI</div>
            <div>
              <a
                href="https://www.facebook.com/linhha2001"
                style={{ margin: "10px" }}
              >
                <img
              ...
              <a
                href="https://www.youtube.com/watch?v=AQW_NgPOnx0"
                style={{ margin: "10px" }}
              >
                <img
              ...
              <a
                href="https://www.instagram.com/hust_dhbkhanoi/"
                style={{ margin: "10px" }}
              >
                <img
